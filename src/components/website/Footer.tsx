...
export default function Footer() {
  return (
    <footer className="border-t border-border/40 bg-white/30 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          {/* Brand */}
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <img src={logo} alt="Butterflaw" className="h-12 object-contain" />
            </div>
            <p className="text-sm text-text-muted leading-relaxed">
              Your personal coach for skin, hair, posture, style, and energy.
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><a href="#programs" className="text-sm text-text-muted hover:text-primary transition-colors">Programs</a></li>
              <li><a href="#download" className="text-sm text-text-muted hover:text-primary transition-colors">Download</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><a href="#" className="text-sm text-text-muted hover:text-primary transition-colors">About</a></li>
              <li><a href="#" className="text-sm text-text-muted hover:text-primary transition-colors">Blog</a></li>
        ...
        <div className="border-t border-border/30 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-text-muted">
            &copy; {new Date().getFullYear()} Butterflaw. All rights reserved.
          </p>
          <div className="flex items-center gap-5">
            ...
            <a href="#" aria-label="TikTok" className="text-text-muted hover:text-primary transition-colors">
